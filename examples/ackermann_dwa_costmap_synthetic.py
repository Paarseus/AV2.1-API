#!/usr/bin/env python3
"""
Ackermann DWA Costmap Example: Synthetic Obstacles

Same as ackermann_dwa_synthetic.py but uses Costmap for collision checking.
"""
...
def main():
    ...
    print("=== Ackermann DWA Costmap Test ===")
    ...
    while plt.fignum_exists(fig.number):
        ...
        # Show costmap (red=obstacle, orange=inflation)
        ax.imshow(costmap.to_rgb(), origin='upper', extent=extent)
        ...
        ax.set_title(f'AckermannDWA + Costmap | v={v:.2f} m/s  steering={math.degrees(steering):.1f} deg')
